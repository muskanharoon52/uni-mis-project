...
<head>
    ...
    <style>
        ...
        .credentials-box { background: #f8f9fa; padding: 10px; border-radius: 8px; font-size: 13px; }
    </style>
</head>
<body>
    <div class="login-card">
        <div class="text-center">
            ...
            <p class="subtitle">University MIS - Exam Management</p>
        </div>

        <?php if ($error): ?>
            <div class="alert alert-danger" style="border-radius:10px;font-size:14px;"><?= htmlspecialchars($error) ?></div>
        <?php endif; ?>
        ...
        <div class="credentials-box">
            ...
            <p class="mb-0">Examiner: <strong>examiner / password123</strong></p>
