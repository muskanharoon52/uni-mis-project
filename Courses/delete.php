...
// Check if course is being used in other tables
// Check in semester_courses if table exists
$is_used = false;
$check_data = ['count' => 0];
...
if (isset($_POST['confirm']) && $_POST['confirm'] === 'yes') {
    // If course is used, prevent deletion
    if ($is_used) {
        ...
        <div class="delete-container">
            ...
            <div class="course-details">
                <dl>
                    ...
                    <dt>Course Title</dt>
                    <dd><?php echo htmlspecialchars($course['course_name']); ?></dd>
                    
                    <dt>Credit Hours</dt>
                    <dd><?php echo $course['credit_hours']; ?></dd>
                    
                    <dt>Semester</dt>
                    <dd><?php echo 'Semester ' . $course['semester']; ?></dd>
                </dl>
            </div>
