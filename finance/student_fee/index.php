...
<head>
    ...
    <title>Student Fees - Finance Module</title>
...
<div class="container-fluid mt-4">
    <div class="row mb-3">
        <div class="col-md-8">
            ...
            <p class="text-muted">View all student fee records and their payment status</p>
        </div>
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item" href="generate.php">
                            <i class="fas fa-file-invoice text-success"></i> Generate Fee
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="index.php">
                            <i class="fas fa-list text-primary"></i> View All Fees
                        </a>
                    </li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <a class="dropdown-item" href="../dashboard.php">
                            <i class="fas fa-arrow-left text-secondary"></i> Back to Dashboard
                        </a>
                    </li>
                </ul>
            </div>
