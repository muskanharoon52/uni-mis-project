...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .role-tabs { display: flex; gap: 8px; margin-bottom: 20px; padding: 4px; border-radius: 12px; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.08); }
        .role-tab { flex: 1; padding: 10px 12px; border: none; border-radius: 9px; background: none; color: rgba(255,255,255,0.55); font-size: .86rem; font-weight: 600; font-family: inherit; cursor: pointer; transition: all .15s; }
        .role-tab.active { background: linear-gradient(135deg, #6366f1, #4f46e5); color: #fff; box-shadow: 0 4px 14px rgba(99,102,241,0.35); }
        ...
        .back-link { display: block; margin-top: 18px; text-align: center; color: #818cf8; font-size: .82rem; text-decoration: none; }
...
<body>
    <div class="login-wrapper">
        <div class="login-brand">
            ...
            <p>System Based Examination portal for teachers and students &mdash; exams, question banks, scheduling and instant results.</p>
            <div class="features">
                <span>Online MCQ-based examinations</span>
                <span>Automatic grading &amp; instant results</span>
                <span>Teacher question banks &amp; scheduling</span>
                <span>Secure role-based access</span>
            </div>
        </div>
        <div class="login-form">
            <h3>Sign In</h3>
            <p class="subtitle">Choose your role and enter your SBE credentials.</p>
            ...
            <div class="role-tabs">
                <button type="button" class="role-tab <?= $formRole === 'Teacher' ? 'active' : '' ?>" data-tab="Teacher" onclick="switchTab('Teacher')">Teacher</button>
                <button type="button" class="role-tab <?= $formRole === 'Student' ? 'active' : '' ?>" data-tab="Student" onclick="switchTab('Student')">Student</button>
            </div>
            ...
            <form class="login-form-pane <?= $formRole === 'Teacher' ? 'active' : '' ?>" data-role="Teacher" method="post" autocomplete="off">
                ...
                <div class="field">
                    ...
                    <input type="text" name="login_id" value="<?= e(old($_POST, 'login_id', '5001')) ?>" placeholder="e.g. 5001" required>
                </div>
                ...
                <button class="btn-login" type="submit">Sign In as Teacher</button>
            </form>
            ...
            <form class="login-form-pane <?= $formRole === 'Student' ? 'active' : '' ?>" data-role="Student" method="post" autocomplete="off">
                ...
                <div class="field">
                    ...
                    <input type="text" name="login_id" value="<?= e(old($_POST, 'login_id', '9001')) ?>" placeholder="e.g. 9001" required>
                </div>
                <div class="field password-field">
                    <label>Password</label>
                    <input type="password" name="password" placeholder="Enter password" required>
                ...
                <button class="btn-login" type="submit">Sign In as Student</button>
            </form>

            <div class="credential-hints">
                <p>Demo Credentials</p>
                <div class="hint-grid">
                    <div class="hint-item"><span class="role-tag tag-teacher">Teacher</span> <span class="cred">5001 / teacher123</span></div>
                    <div class="hint-item"><span class="role-tag tag-student">Student</span> <span class="cred">9001 / student123</span></div>
                    <div class="hint-item"><span class="role-tag tag-teacher">Teacher</span> <span class="cred">5002 / teacher123</span></div>
                    <div class="hint-item"><span class="role-tag tag-student">Student</span> <span class="cred">9002 / student123</span></div>
                </div>
            </div>

            <a class="back-link" href="../../index.php">&larr; Back to Main Portal</a>
        </div>
    </div>
    ...
    function togglePass() {
        var active = document.querySelector('.login-form-pane.active .password-field input[type="password"]') ||
                     document.querySelector('.login-form-pane.active input[name="password"]');
        if (active) { active.type = active.type === 'password' ? 'text' : 'password'; }
    }
    </script>
</body>
</html>
