...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    <tr><th>Student ID</th><td><strong><?= $student['student_id'] ?? 'N/A' ?></strong></td></tr>
                    <tr><th>Student Name</th><td><?= $student['student_name'] ?? 'N/A' ?></td></tr>
                    <tr><th>Father Name</th><td><?= $student['father_name'] ?? 'N/A' ?></td></tr>
                    <tr><th>CNIC/B-Form</th><td><?= $student['cnic_or_bform'] ?? 'N/A' ?></td></tr>
                    <tr><th>Date of Birth</th><td><?= isset($student['dob']) ? date('d M Y', strtotime($student['dob'])) : 'N/A' ?></td></tr>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    <tr><th>Department</th><td><?= $student['department_name'] ?? 'N/A' ?></td></tr>
                    <tr><th>Status</th>
                        <td>
                            <?php 
                    ...
                    <tr><th>Added Date</th><td><?= date('d M Y', strtotime($student['created_at'])) ?></td></tr>
                    <?php endif; ?>
                    <?php if (!empty($student['application_id'])): ?>
                    <tr><th>Application ID</th><td><?= $student['application_id'] ?></td></tr>
                    <?php endif; ?>
                    <?php if (!empty($student['enrollment_date'])): ?>
                    <tr><th>Enrollment Date</th><td><?= date('d M Y', strtotime($student['enrollment_date'])) ?></td></tr>
                    <?php endif; ?>
                </table>
            </div>
        </div>
