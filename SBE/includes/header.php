        ...
        <nav class="nav">
            ...
            <?php elseif ($userRole === 'teacher'): ?>
                ...
                <a class="<?= $activePage === 'exam_questions' ? 'active' : '' ?>" href="exam-questions.php">
                    <span class="nav-icon">🗂️</span> Question Mapping
                </a>
                ...
                <a class="<?= $activePage === 'student_answers' ? 'active' : '' ?>" href="student-answers.php">
                    <span class="nav-icon">✍️</span> Answer Audits
                </a>
            ...
            <?php elseif ($userRole === 'student'): ?>
                ...
                <a class="<?= $activePage === 'student_start_exam' ? 'active' : '' ?>" href="student-start-exam.php">
                    <span class="nav-icon">▶️</span> Start Exam
                </a>
            <?php endif; ?>
        </nav>
            ...
            <?php if ($user): ?>
                <div class="user-strip">
                    ...
                    <div class="user-strip-info">
                        ...
                        <span class="user-strip-role"><?= ucfirst(e($user['role'])) ?> · <?= e($user['login_id']) ?></span>
                    </div>
                </div>
                <div class="actions">
                    <a class="btn btn-ghost btn-sm" href="profile.php">⚙️ Profile</a>
    ...
    <main class="content">
        <div class="topbar">
            ...
            <div class="topbar-actions">
                <?php if ($user): ?>
                    <span class="badge <?= e($user['role']) ?>"><?= ucfirst(e($user['role'])) ?></span>
